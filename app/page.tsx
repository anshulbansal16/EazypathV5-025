    ...
    <div className="container mx-auto py-12">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16 p-8 rounded-2xl gradient-bg-1">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Button
            asChild
            size="lg"
            className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
          >
            <Link href="/login">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="border-primary/20 hover:bg-primary/10 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
          >
      ...
      <div className="py-16 mt-16 text-center">
        ...
        <Button
          asChild
          size="lg"
          className="bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 animate-pulse-slow"
        >
          <Link href="/login">
