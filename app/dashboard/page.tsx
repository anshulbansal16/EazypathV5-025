...
import { Activity, FileText, User, BarChart3, Calendar, Loader2, LogOut, Plus, ChevronRight } from "lucide-react"
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <Button
                        asChild
                        className="w-full justify-start bg-primary/10 text-primary hover:bg-primary/20 shadow-sm hover:shadow transition-all"
                      >
